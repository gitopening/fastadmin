...
class Usertt extends Frontend
{
    ...
    public function register()
    {
        ...
        // die;
        if ($this->auth->id) {
            $this->success(__('You\'ve logged in, do not login again'), $url ? $url : url('usertt/index'));
        }
        if ($this->request->isPost()) {
            ...
            if ($this->auth->registerTT($username, $password)) {
                $this->success(__('Sign up successful'), $url ? $url : url('usertt/index'));
            } else {
    ...
    public function login()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($this->auth->login($account, $password)) {
                $this->success(__('Logged in successful'), $url ? $url : url('usertt/index'));
            } else {
                $this->error($this->auth->getError(), null, ['token' => $this->request->token()]);
            }
        }
    ...
    public function logout()
    {
        if ($this->request->isPost()) {
            ...
            //退出本站
            $this->auth->logout();
            $this->success(__('Logout successful'), url('usertt/index'));
        }
    ...
    public function changepwd()
    {
        if ($this->request->isPost()) {
            ...
            if ($ret) {
                $this->success(__('Reset password successful'), url('usertt/login'));
            } else {
                $this->error($this->auth->getError(), null, ['token' => $this->request->token()]);
            }
        }
